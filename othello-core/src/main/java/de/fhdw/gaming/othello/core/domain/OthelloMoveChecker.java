...
/**
 * An Othello {@link MoveChecker} checking for supported Othello moves.
 */
public interface OthelloMoveChecker extends MoveChecker<OthelloPlayer, OthelloState, OthelloMove> {
}
