...
/**
 * Implements {@link OthelloStrategyFactory} by creating an {@link OthelloMinOppMob}. An object of this class is
 ...
 */
public final class OthelloMinOppMobStrategyFactory implements OthelloStrategyFactory {

    @Override
    public OthelloStrategy create(final OthelloMoveFactory moveFactory) {
        return new OthelloMinOppMob(moveFactory);
    }
}
