 ...
 */
package de.fhdw.gaming.othello.strategy.examples.minMaxD3;
...
/**
 * Implements {@link OthelloStrategyFactory} by creating an {@link OthelloMinMaxD3Strategy}. An object of this class is
 ...
 */
public final class OthelloMinMaxD3StrategyFactory implements OthelloStrategyFactory {

    @Override
    public OthelloStrategy create(final OthelloMoveFactory moveFactory) {
        return new OthelloMinMaxD3Strategy(moveFactory);
    }
}
