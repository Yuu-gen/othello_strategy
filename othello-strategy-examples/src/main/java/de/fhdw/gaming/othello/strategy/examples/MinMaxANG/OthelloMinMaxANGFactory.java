...
/**
 * Implements {@link OthelloStrategyFactory} by creating an {@link OthelloMinMaxANGStrategy}. An object of this class is
 ...
 */
public final class OthelloMinMaxANGFactory implements OthelloStrategyFactory {

    @Override
    public OthelloStrategy create(final OthelloMoveFactory moveFactory) {
        return new OthelloMinMaxANGStrategy(moveFactory);
    }
}
