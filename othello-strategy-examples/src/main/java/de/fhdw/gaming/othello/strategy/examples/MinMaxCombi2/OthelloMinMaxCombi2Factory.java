...
/**
 * Implements {@link OthelloStrategyFactory} by creating an {@link OthelloMinMaxCombi2Strategy}. An object of this class is
 ...
 */
public final class OthelloMinMaxCombi2Factory implements OthelloStrategyFactory {

    @Override
    public OthelloStrategy create(final OthelloMoveFactory moveFactory) {
        return new OthelloMinMaxCombi2Strategy(moveFactory);
    }
}
